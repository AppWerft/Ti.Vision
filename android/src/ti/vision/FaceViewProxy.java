...
public class FaceViewProxy extends TiViewProxy {
	...
	private class VisionView extends TiUIView {
		public VisionView(TiViewProxy proxy) {
			...
			Log.d(LCAT,"container.addView(preview)");
			preview.setOnTouchListener(touchListener);
	...
	private void createCameraSource() {
		...
		//textRecognizer.setProcessor(new OcrDetectorProcessor(FaceViewProxy.this,graphicOverlay));
